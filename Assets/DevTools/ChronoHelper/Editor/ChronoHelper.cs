...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    private void CreateChronoButtons()
    {
        _chronoButtons = new ChronoButton[]{
            ...
            new ChronoButton(this, 4.000f, new GUIContent("x4")),
            new ChronoButton(this, 6.000f, new GUIContent("x6")),
            new ChronoButton(this, 10.000f, new GUIContent("x10"))
        };
    }
    ...
    private void DrawChronoSlider()
    {
        using (new EditorGUILayout.HorizontalScope())
        {
            ...
            _chronoScale = EditorGUILayout.Slider(_chronoScale, 0.0f, 8.0f, kChronoSliderExpandWidth, kChronoSliderMaxWidth);
